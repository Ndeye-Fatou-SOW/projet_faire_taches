...
import '../providers/todo_history_provider.dart';

class TodoHistoryPage extends StatelessWidget {
  final int accountId;
  const TodoHistoryPage({Key? key, required this.accountId}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      create: (_) {
        final provider = TodoHistoryProvider();
        provider.loadTodos(accountId); // 🔥 charger dès l’ouverture
        return provider;
      },
      child: Consumer<TodoHistoryProvider>(
